...
import * as SdkClientStdio from '@modelcontextprotocol/sdk/client/stdio.js';
  ...
  describe('createTransport', () => {
    ...
    it('should connect via command', () => {
      ...
      const mockedTransport = vi
        .mocked(SdkClientStdio.StdioClientTransport)
        .mockImplementation(
          () =>
            ({
              stderr: {
            ...
            }) as unknown as SdkClientStdio.StdioClientTransport,
        );
